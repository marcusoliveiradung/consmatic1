...
from holoteca.models import  Artefato_Teca #, Artefato_Remissiologia
#********ARTEFATO*e FICHA*************************************************
...
class Artefato_has_Ocurrences_Inline(admin.TabularInline):
...
class Dominiologia_Inline(admin.StackedInline):
...
#admin.site.register(Tipo_Atributo)
